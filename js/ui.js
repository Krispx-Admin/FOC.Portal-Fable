...
export const icons = {
  ...
  lens: I('<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3.5"/><path d="M6.9 7.3a7 7 0 0 1 2.7-2"/>'),
  calendar: I('<rect width="18" height="18" x="3" y="4" rx="2"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/>'),
};
